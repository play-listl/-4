document.addEventListener('DOMContentLoaded', function() {
    ...
    const points = {
        'Thriller by Michael Jackson': [20, 12, 8, 6, 4, 3, 2, 0],
        'Back in Black by AC/DC': [16, 16, 11, 7, 5, 4, 2, 1],
        'The Dark Side of the Moon by Pink Floyd': [12, 12, 14, 9, 7, 5, 3, 2],
        'The Bodyguard by Whitney Houston': [10, 10, 11, 12, 8, 6, 4, 4],
        'Bat Out of Hell by Meat Loaf': [8, 8, 8, 9, 11, 8, 5, 5],
        'Their Greatest Hits (1971/1975) by Eagles': [6, 6, 7, 7, 8, 10, 7, 5],
        'Saturday Night Fever by Bee Gees': [5, 5, 5, 6, 7, 9, 9, 7],
        'Rumours by Fleetwood Mac': [4, 4, 4, 4, 5, 6, 7, 8]
    };

    const correctOrder = [
        { city: 'Thriller by Michael Jackson', year: '66 million' },
        { city: 'Back in Black by AC/DC', year: '50 million' },
        { city: 'The Dark Side of the Moon by Pink Floyd', year: '145 million' },
        { city: 'The Bodyguard by Whitney Houston', year: '45 million' },
        { city: 'Bat Out of Hell by Meat Loaf', year: '43 million' },
        { city: 'Their Greatest Hits (1971/1975) by Eagles', year: '142 million' },
        { city: 'Saturday Night Fever by Bee Gees', year: '40 million' },
        { city: 'Rumours by Fleetwood Mac', year: '40 million' }
    ];
